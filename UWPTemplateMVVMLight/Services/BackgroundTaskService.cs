...
using UWPTemplateMVVMLight.Activation;
using UWPTemplateMVVMLight.BackgroundTasks;
using UWPTemplateMVVMLight.Core.Helpers;

using Windows.ApplicationModel.Activation;
using Windows.ApplicationModel.Background;

namespace UWPTemplateMVVMLight.Services
{
